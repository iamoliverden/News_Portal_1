...
class Post(models.Model):
    ...
    def preview_124(self): # method that returns the beginning of the article (preview) with 124 characters and adds an ellipsis at the end
        return self.content[:124] + '...'

    def preview_20(self):  # method that returns the beginning of the article (preview) with 124 characters and adds an ellipsis at the end
